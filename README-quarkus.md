...
```shell script
java -jar structure-for-llm/build/libs/structure-for-llm.jar $PWD/project-context.md
```
...
You can then execute your native executable with: `./build/nutri-panda-1.0.0-SNAPSHOT-runner`
